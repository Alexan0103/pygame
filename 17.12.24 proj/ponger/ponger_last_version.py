...
def main():
    ...
    while run == 1:
        ...
        while not gameover:
            ...
            left_wall_x = ((WIDTH - WALL_WIDTH) // 2)

            # Отрисовка стенок
            pygame.draw.rect(screen, (255, 255, 255), (left_wall_x, 100, 20, 200))
            ...
            if gameover:
                ...
                if scoreleft == 1:
                    text_surface = font.render("PLAYER L WIN", True, BLUE)
                else:
            ...
            if ballservice is not TRUE:
                ...
                if left_wall_x <= ballxy[0] <= left_wall_x + 20 and 100 <= ballxy[1] <= 300:
                    balldx = -balldx
